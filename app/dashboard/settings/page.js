  ...
  return (
    <div className="px-5 pt-4 pb-32">
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <div className="text-[19px] font-bold text-white tracking-tight">{nombre}</div>
            {telefonoFormat && (
      ...
      >
        <div className="flex items-center gap-3 py-3.5" style={{ borderBottom: '1px solid #242424' }}>
          <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: '#242424' }}>
            <IconUser size={16} color="#A1A1AA" />
          </div>
          <div className="flex-1">
            <div className="text-[13px] text-muted">Cómo prefieres que te llame</div>
            <div className="text-[14px] font-bold text-white mt-0.5">{nombre}</div>
          </div>
        </div>
        <div className="flex items-center gap-3 py-3.5">
          ...
          <div className="flex-1">
            ...
            <div className="text-[14px] font-bold text-white mt-0.5">{telefonoFormat || '—'}</div>
          </div>
        </div>
      </div>
      ...
      >
        <div className="flex items-center gap-3 py-3.5">
          <div className="w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0" style={{ background: '#242424' }}>
            <IconInfoCircle size={16} color="#A1A1AA" />
          </div>
          <div className="flex-1">
            <div className="text-[14px] font-bold text-white">Du Life</div>
